...
const form = {
  ...
  codecs: {
    video: [
      ...
      { name: 'av1_nvenc (Nvidia NVENC)', value: 'av1_nvenc', supported: ['mp4', 'mkv'] },
      ...
      { name: 'AV1 (libsvtav1)', value: 'av1', supported: ['mp4', 'mkv', 'webm'] },
      { name: 'VP8', value: 'vp8', supported: ['mp4', 'webm', 'mkv', 'avi'] },
      { name: 'VP9', value: 'vp9', supported: ['mp4', 'webm', 'mkv', 'avi'] },
      { name: 'copy (Stream Copy - No re-encode)', value: 'copy', supported: null },
...
sizes: [
    ...
    { name: '8K', value: '8k' },
    { name: '8K UHD', value: '8k_uhd' },
    { name: '4K', value: '4k' },
    { name: '4K UHD', value: '4k_uhd' },
    { name: '2K', value: '2k' },
